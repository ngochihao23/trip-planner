...
const utilities = [
    { icon: Newspaper, label: 'Tin tức du lịch', desc: 'Cập nhật tin mới nhất' },
    { icon: Building2, label: 'Công ty lữ hành', desc: 'Danh sách đối tác uy tín' },
    { icon: Users, label: 'Hướng dẫn viên', desc: 'Tìm HDV chuyên nghiệp' },
];
